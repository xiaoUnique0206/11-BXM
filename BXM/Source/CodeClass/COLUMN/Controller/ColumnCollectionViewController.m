...
@implementation ColumnCollectionViewController
static NSString *const headIdent = @"headCell";
static NSString * const reuseIdentifier = @"Cell";
static NSString *const ident = @"cell";
static NSString *const collIdent = @"collCell";
static NSString *const footIdent = @"footCell";
